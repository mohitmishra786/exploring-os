...
| 7 | Process Scheduling Basics | Scheduling | Medium | FCFS Algorithm |
| 8 | Scheduling Algorithms | Scheduling | Hard | SJF, Priority, Round Robin |
| 9 | Context Switching | Processes | Hard | Implementation Details |
| 10 | Thread Concept | Threads | Easy | Thread Basic Understanding |
| 11 | Thread Creation and Management | Threads | Medium | POSIX Threads |
| 12 | Thread vs Process Comparison | Threads | Medium | Comparative Analysis |
| 13 | Multithreading Models | Threads | Hard | User vs Kernel Threads |
| 14 | Concurrency Fundamentals | Synchronization | Medium | Race Conditions |
| 15 | Mutex and Semaphores | Synchronization | Hard | Implementation |
| 16 | Deadlock Concepts | Synchronization | Hard | Prevention Strategies |
| 17 | Deadlock Detection Algorithms | Synchronization | Hard | Banker's Algorithm |
| 18 | Memory Management Overview | Memory | Easy | Memory Hierarchy |
| 19 | Logical vs Physical Address | Memory | Medium | Address Translation |
| 20 | Contiguous Memory Allocation | Memory | Medium | Allocation Strategies |
| 21 | Paging Mechanism | Memory | Hard | Page Table Implementation |
| 22 | Page Replacement Algorithms | Memory | Hard | FIFO, LRU, Optimal |
| 23 | Segmentation | Memory | Medium | Segment Table |
| 24 | Virtual Memory Concepts | Memory | Hard | Demand Paging |
| 25 | File System Basics | File Systems | Easy | File Concept |
| 26 | File System Structure | File Systems | Medium | Directory Structures |
| 27 | File Allocation Methods | File Systems | Medium | Contiguous, Linked |
| 28 | Free Space Management | File Systems | Hard | Bit Vector, Linked List |
| 29 | File Protection Mechanisms | File Systems | Medium | Access Control |
